...
public class OAuthTokenProvider implements AuthenticationProvider {
    private final Logger log = LoggerFactory.getLogger(OAuthTokenProvider.class);
    @Override
    public void authenticate() { log.info("Authorized user [{}]",this.getClass().getSimpleName()); }
}